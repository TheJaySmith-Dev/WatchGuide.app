      ...
      >
        {items.map((item, index) => (
          <div
            ...
            className={`flex-none relative cursor-pointer group transition-all duration-300 hover:scale-105 hover:z-10 snap-center 
              ${isPoster ? 'w-[140px] md:w-[200px]' : 'w-[260px] md:w-[350px]'}
              /* First item offset to clear sidebar */
              ${index === 0 ? 'md:ml-40' : ''} 
              /* Last item padding */
