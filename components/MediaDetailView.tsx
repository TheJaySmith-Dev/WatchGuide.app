...
import { X, Calendar, Star, Clock, Play, DollarSign, Users, Award, ExternalLink } from 'lucide-react';
      ...
      <div className="w-full h-full md:max-w-7xl md:h-[90vh] bg-black/40 md:rounded-3xl overflow-y-auto shadow-2xl relative border border-white/10 backdrop-blur-sm">
        ...
        <div className="relative h-[40vh] md:h-[50vh]">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 flex flex-col md:flex-row items-end gap-8">
            ...
            {trailer && (
                 <a href="#trailer" className="hidden md:flex items-center gap-3 bg-white/90 backdrop-blur-sm text-black px-8 py-4 rounded-full font-bold hover:scale-105 transition-transform shadow-lg shadow-white/10">
